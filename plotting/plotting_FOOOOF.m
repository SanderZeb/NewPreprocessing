...
errorbar(1, squeeze(mean(results_exp1.difference_incid)),(sem(results_exp1.difference_incid) - squeeze(mean(results_exp1.difference_incid))), "red")
scatter(2, squeeze(mean(results_exp1.difference_corrid)), "blue")
errorbar(2, squeeze(mean(results_exp1.difference_corrid)),(sem(results_exp1.difference_corrid) - squeeze(mean(results_exp1.difference_corrid))), "blue")

scatter(3, squeeze(mean(results_exp3.difference_incid)), "red")
errorbar(3, squeeze(mean(results_exp3.difference_incid)),(sem(results_exp3.difference_incid) - squeeze(mean(results_exp3.difference_incid))), "red")
scatter(4, squeeze(mean(results_exp3.difference_corrid)), "blue")
errorbar(4, squeeze(mean(results_exp3.difference_corrid)),(sem(results_exp3.difference_corrid) - squeeze(mean(results_exp3.difference_corrid))), "blue")
if settings.plot_4th == 1
    scatter(5, squeeze(mean(results_exp4.difference_incid)), "red")
    errorbar(5, squeeze(mean(results_exp4.difference_incid)),(sem(results_exp4.difference_incid) - squeeze(mean(results_exp4.difference_incid))), "red")
    scatter(6, squeeze(mean(results_exp4.difference_corrid)), "blue")
    errorbar(6, squeeze(mean(results_exp4.difference_corrid)),(sem(results_exp4.difference_corrid) - squeeze(mean(results_exp4.difference_corrid))), "blue")


    scatter(7, squeeze(mean(results_exp5_obj.difference_incid)), "red")
    errorbar(7, squeeze(mean(results_exp5_obj.difference_incid)),(sem(results_exp5_obj.difference_incid) - squeeze(mean(results_exp5_obj.difference_incid))), "red")
    scatter(8, squeeze(mean(results_exp5_obj.difference_corrid)), "blue")
    errorbar(8, squeeze(mean(results_exp5_obj.difference_corrid)),(sem(results_exp5_obj.difference_corrid) - squeeze(mean(results_exp5_obj.difference_corrid))), "blue")


    scatter(9, squeeze(mean(results_exp5_bgr.difference_incid)), "red")
    errorbar(9, squeeze(mean(results_exp5_bgr.difference_incid)),(sem(results_exp5_bgr.difference_incid) - squeeze(mean(results_exp5_bgr.difference_incid))), "red")
    scatter(10, squeeze(mean(results_exp5_bgr.difference_corrid)), "blue")
    errorbar(10, squeeze(mean(results_exp5_bgr.difference_corrid)),(sem(results_exp5_bgr.difference_corrid) - squeeze(mean(results_exp5_bgr.difference_corrid))), "blue")
end
...
errorbar(2, squeeze(mean(results_exp1.central_freq_corrid)),(sem(results_exp1.central_freq_corrid) - squeeze(mean(results_exp1.central_freq_corrid))), "blue")
scatter(1, squeeze(mean(results_exp1.central_freq_incid)), "red")
errorbar(1, squeeze(mean(results_exp1.central_freq_incid)),(sem(results_exp1.central_freq_incid) - squeeze(mean(results_exp1.central_freq_incid))), "red")

scatter(4, squeeze(mean(results_exp3.central_freq_corrid)), "blue")
errorbar(4, squeeze(mean(results_exp3.central_freq_corrid)),(sem(results_exp3.central_freq_corrid) - squeeze(mean(results_exp3.central_freq_corrid))), "blue")
scatter(3, squeeze(mean(results_exp3.central_freq_incid)), "red")
errorbar(3, squeeze(mean(results_exp3.central_freq_incid)),(sem(results_exp3.central_freq_incid) - squeeze(mean(results_exp3.central_freq_incid))), "red")

if settings.plot_4th == 1
    scatter(5, squeeze(mean(results_exp4.central_freq_incid)), "red")
    errorbar(5, squeeze(mean(results_exp4.central_freq_incid)),(sem(results_exp4.central_freq_incid) - squeeze(mean(results_exp4.central_freq_incid))), "red")
    scatter(6, squeeze(mean(results_exp4.central_freq_corrid)), "blue")
    errorbar(6, squeeze(mean(results_exp4.central_freq_corrid)),(sem(results_exp4.central_freq_corrid) - squeeze(mean(results_exp4.central_freq_corrid))), "blue")


    scatter(7, squeeze(mean(results_exp5_obj.central_freq_incid)), "red")
    errorbar(7, squeeze(mean(results_exp5_obj.central_freq_incid)),(sem(results_exp5_obj.central_freq_incid) - squeeze(mean(results_exp5_obj.central_freq_incid))), "red")
    scatter(8, squeeze(mean(results_exp5_obj.central_freq_corrid)), "blue")
    errorbar(8, squeeze(mean(results_exp5_obj.central_freq_corrid)),(sem(results_exp5_obj.central_freq_corrid) - squeeze(mean(results_exp5_obj.central_freq_corrid))), "blue")


    scatter(9, squeeze(mean(results_exp5_bgr.central_freq_incid)), "red")
    errorbar(9, squeeze(mean(results_exp5_bgr.central_freq_incid)),(sem(results_exp5_bgr.central_freq_incid) - squeeze(mean(results_exp5_bgr.central_freq_incid))), "red")
    scatter(10, squeeze(mean(results_exp5_bgr.central_freq_corrid)), "blue")
    errorbar(10, squeeze(mean(results_exp5_bgr.central_freq_corrid)),(sem(results_exp5_bgr.central_freq_corrid) - squeeze(mean(results_exp5_bgr.central_freq_corrid))), "blue")
end
...
errorbar(2, squeeze(mean(results_exp1.bandwith_freq_corrid)),(sem(results_exp1.bandwith_freq_corrid) - squeeze(mean(results_exp1.bandwith_freq_corrid))), "blue")
scatter(1, squeeze(mean(results_exp1.bandwith_freq_incid)), "red")
errorbar(1, squeeze(mean(results_exp1.bandwith_freq_incid)),(sem(results_exp1.bandwith_freq_incid) - squeeze(mean(results_exp1.bandwith_freq_incid))), "red")

scatter(4, squeeze(mean(results_exp3.bandwith_freq_corrid)), "blue")
errorbar(4, squeeze(mean(results_exp3.bandwith_freq_corrid)),(sem(results_exp3.bandwith_freq_corrid) - squeeze(mean(results_exp3.bandwith_freq_corrid))), "blue")
scatter(3, squeeze(mean(results_exp3.bandwith_freq_incid)), "red")
errorbar(3, squeeze(mean(results_exp3.bandwith_freq_incid)),(sem(results_exp3.bandwith_freq_incid) - squeeze(mean(results_exp3.bandwith_freq_incid))), "red")


if settings.plot_4th == 1
    scatter(5, squeeze(mean(results_exp4.bandwith_freq_incid)), "red")
    errorbar(5, squeeze(mean(results_exp4.bandwith_freq_incid)),(sem(results_exp4.bandwith_freq_incid) - squeeze(mean(results_exp4.bandwith_freq_incid))), "red")
    scatter(6, squeeze(mean(results_exp4.bandwith_freq_corrid)), "blue")
    errorbar(6, squeeze(mean(results_exp4.bandwith_freq_corrid)),(sem(results_exp4.bandwith_freq_corrid) - squeeze(mean(results_exp4.bandwith_freq_corrid))), "blue")


    scatter(7, squeeze(mean(results_exp5_obj.bandwith_freq_incid)), "red")
    errorbar(7, squeeze(mean(results_exp5_obj.bandwith_freq_incid)),(sem(results_exp5_obj.bandwith_freq_incid) - squeeze(mean(results_exp5_obj.bandwith_freq_incid))), "red")
    scatter(8, squeeze(mean(results_exp5_obj.bandwith_freq_corrid)), "blue")
    errorbar(8, squeeze(mean(results_exp5_obj.bandwith_freq_corrid)),(sem(results_exp5_obj.bandwith_freq_corrid) - squeeze(mean(results_exp5_obj.bandwith_freq_corrid))), "blue")


    scatter(9, squeeze(mean(results_exp5_bgr.bandwith_freq_incid)), "red")
    errorbar(9, squeeze(mean(results_exp5_bgr.bandwith_freq_incid)),(sem(results_exp5_bgr.bandwith_freq_incid) - squeeze(mean(results_exp5_bgr.bandwith_freq_incid))), "red")
    scatter(10, squeeze(mean(results_exp5_bgr.bandwith_freq_corrid)), "blue")
    errorbar(10, squeeze(mean(results_exp5_bgr.bandwith_freq_corrid)),(sem(results_exp5_bgr.bandwith_freq_corrid) - squeeze(mean(results_exp5_bgr.bandwith_freq_corrid))), "blue")
end
...
errorbar(1, squeeze(mean(results_exp1.aperiodic_incid)),(sem(results_exp1.aperiodic_incid) - squeeze(mean(results_exp1.aperiodic_incid))), "red")
scatter(2, squeeze(mean(results_exp1.aperiodic_corrid)), "blue")
errorbar(2, squeeze(mean(results_exp1.aperiodic_corrid)),(sem(results_exp1.aperiodic_corrid) - squeeze(mean(results_exp1.aperiodic_corrid))), "blue")

scatter(3, squeeze(mean(results_exp3.aperiodic_incid)), "red")
errorbar(3, squeeze(mean(results_exp3.aperiodic_incid)),(sem(results_exp3.aperiodic_incid) - squeeze(mean(results_exp3.aperiodic_incid))), "red")
scatter(4, squeeze(mean(results_exp3.aperiodic_corrid)), "blue")
errorbar(4, squeeze(mean(results_exp3.aperiodic_corrid)),(sem(results_exp3.aperiodic_corrid) - squeeze(mean(results_exp3.aperiodic_corrid))), "blue")

if settings.plot_4th == 1
    scatter(5, squeeze(mean(results_exp4.aperiodic_incid)), "red")
    errorbar(5, squeeze(mean(results_exp4.aperiodic_incid)),(sem(results_exp4.aperiodic_incid) - squeeze(mean(results_exp4.aperiodic_incid))), "red")
    scatter(6, squeeze(mean(results_exp4.aperiodic_corrid)), "blue")
    errorbar(6, squeeze(mean(results_exp4.aperiodic_corrid)),(sem(results_exp4.aperiodic_corrid) - squeeze(mean(results_exp4.aperiodic_corrid))), "blue")


    scatter(7, squeeze(mean(results_exp5_obj.aperiodic_incid)), "red")
    errorbar(7, squeeze(mean(results_exp5_obj.aperiodic_incid)),(sem(results_exp5_obj.aperiodic_incid) - squeeze(mean(results_exp5_obj.aperiodic_incid))), "red")
    scatter(8, squeeze(mean(results_exp5_obj.aperiodic_corrid)), "blue")
    errorbar(8, squeeze(mean(results_exp5_obj.aperiodic_corrid)),(sem(results_exp5_obj.aperiodic_corrid) - squeeze(mean(results_exp5_obj.aperiodic_corrid))), "blue")


    scatter(9, squeeze(mean(results_exp5_bgr.aperiodic_incid)), "red")
    errorbar(9, squeeze(mean(results_exp5_bgr.aperiodic_incid)),(sem(results_exp5_bgr.aperiodic_incid) - squeeze(mean(results_exp5_bgr.aperiodic_incid))), "red")
    scatter(10, squeeze(mean(results_exp5_bgr.aperiodic_corrid)), "blue")
    errorbar(10, squeeze(mean(results_exp5_bgr.aperiodic_corrid)),(sem(results_exp5_bgr.aperiodic_corrid) - squeeze(mean(results_exp5_bgr.aperiodic_corrid))), "blue")
end
...
errorbar(2, squeeze(mean(results_exp1.exponent_corrid)),(sem(results_exp1.exponent_corrid) - squeeze(mean(results_exp1.exponent_corrid))), "blue")
scatter(1, squeeze(mean(results_exp1.exponent_incid)), "red")
errorbar(1, squeeze(mean(results_exp1.exponent_incid)),(sem(results_exp1.exponent_incid) - squeeze(mean(results_exp1.exponent_incid))), "red")

scatter(4, squeeze(mean(results_exp3.exponent_corrid)), "blue")
errorbar(4, squeeze(mean(results_exp3.exponent_corrid)),(sem(results_exp3.exponent_corrid) - squeeze(mean(results_exp3.exponent_corrid))), "blue")
scatter(3, squeeze(mean(results_exp3.exponent_incid)), "red")
errorbar(3, squeeze(mean(results_exp3.exponent_incid)),(sem(results_exp3.exponent_incid) - squeeze(mean(results_exp3.exponent_incid))), "red")

if settings.plot_4th == 1
    scatter(5, squeeze(mean(results_exp4.exponent_incid)), "red")
    errorbar(5, squeeze(mean(results_exp4.exponent_incid)),(sem(results_exp4.exponent_incid) - squeeze(mean(results_exp4.exponent_incid))), "red")
    scatter(6, squeeze(mean(results_exp4.exponent_corrid)), "blue")
    errorbar(6, squeeze(mean(results_exp4.exponent_corrid)),(sem(results_exp4.exponent_corrid) - squeeze(mean(results_exp4.exponent_corrid))), "blue")


    scatter(7, squeeze(mean(results_exp5_obj.exponent_incid)), "red")
    errorbar(7, squeeze(mean(results_exp5_obj.exponent_incid)),(sem(results_exp5_obj.exponent_incid) - squeeze(mean(results_exp5_obj.exponent_incid))), "red")
    scatter(8, squeeze(mean(results_exp5_obj.exponent_corrid)), "blue")
    errorbar(8, squeeze(mean(results_exp5_obj.exponent_corrid)),(sem(results_exp5_obj.exponent_corrid) - squeeze(mean(results_exp5_obj.exponent_corrid))), "blue")


    scatter(9, squeeze(mean(results_exp5_bgr.exponent_incid)), "red")
    errorbar(9, squeeze(mean(results_exp5_bgr.exponent_incid)),(sem(results_exp5_bgr.exponent_incid) - squeeze(mean(results_exp5_bgr.exponent_incid))), "red")
    scatter(10, squeeze(mean(results_exp5_bgr.exponent_corrid)), "blue")
    errorbar(10, squeeze(mean(results_exp5_bgr.exponent_corrid)),(sem(results_exp5_bgr.exponent_corrid) - squeeze(mean(results_exp5_bgr.exponent_corrid))), "blue")
end
...
errorbar(2, squeeze(mean(results_exp1.offset_flat_corrid)),(sem(results_exp1.offset_flat_corrid) - squeeze(mean(results_exp1.offset_flat_corrid))), "blue")
scatter(1, squeeze(mean(results_exp1.offset_flat_incid)), "red")
errorbar(1, squeeze(mean(results_exp1.offset_flat_incid)),(sem(results_exp1.offset_flat_incid) - squeeze(mean(results_exp1.offset_flat_incid))), "red")

scatter(4, squeeze(mean(results_exp3.offset_flat_corrid)), "blue")
errorbar(4, squeeze(mean(results_exp3.offset_flat_corrid)),(sem(results_exp3.offset_flat_corrid) - squeeze(mean(results_exp3.offset_flat_corrid))), "blue")
scatter(3, squeeze(mean(results_exp3.offset_flat_incid)), "red")
errorbar(3, squeeze(mean(results_exp3.offset_flat_incid)),(sem(results_exp3.offset_flat_incid) - squeeze(mean(results_exp3.offset_flat_incid))), "red")

if settings.plot_4th == 1
    scatter(5, squeeze(mean(results_exp4.offset_flat_incid)), "red")
    errorbar(5, squeeze(mean(results_exp4.offset_flat_incid)),(sem(results_exp4.offset_flat_incid) - squeeze(mean(results_exp4.offset_flat_incid))), "red")
    scatter(6, squeeze(mean(results_exp4.offset_flat_corrid)), "blue")
    errorbar(6, squeeze(mean(results_exp4.offset_flat_corrid)),(sem(results_exp4.offset_flat_corrid) - squeeze(mean(results_exp4.offset_flat_corrid))), "blue")


    scatter(7, squeeze(mean(results_exp5_obj.offset_flat_incid)), "red")
    errorbar(7, squeeze(mean(results_exp5_obj.offset_flat_incid)),(sem(results_exp5_obj.offset_flat_incid) - squeeze(mean(results_exp5_obj.offset_flat_incid))), "red")
    scatter(8, squeeze(mean(results_exp5_obj.offset_flat_corrid)), "blue")
    errorbar(8, squeeze(mean(results_exp5_obj.offset_flat_corrid)),(sem(results_exp5_obj.offset_flat_corrid) - squeeze(mean(results_exp5_obj.offset_flat_corrid))), "blue")


    scatter(9, squeeze(mean(results_exp5_bgr.offset_flat_incid)), "red")
    errorbar(9, squeeze(mean(results_exp5_bgr.offset_flat_incid)),(sem(results_exp5_bgr.offset_flat_incid) - squeeze(mean(results_exp5_bgr.offset_flat_incid))), "red")
    scatter(10, squeeze(mean(results_exp5_bgr.offset_flat_corrid)), "blue")
    errorbar(10, squeeze(mean(results_exp5_bgr.offset_flat_corrid)),(sem(results_exp5_bgr.offset_flat_corrid) - squeeze(mean(results_exp5_bgr.offset_flat_corrid))), "blue")
end
