for paradigm = 2:2
    ...
    elseif settings.paradigm == 3
        root = 'D:\Drive\3 - Mask\';
        participants_to_drop = [128 129 162 142 145 103 66 41]; % due to the poor ICA decoposition
    ...
    mkdir(pathTFData, 'plots_pas2');
    savepath = [pathTFData '\plots_pas2\']
...
%         idx_highpas = [participant_event.pas_resp] >= 3;
%         idx_lowpas = [participant_event.pas_resp] == 2;
