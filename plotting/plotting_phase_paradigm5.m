...
%             participant_event([id_to_drop]) = [];
            ...
            idx_ttobject_highpas = [participant_event.pas] >= 2 & idx_object;
            idx_ttobject_lowpas = [participant_event.pas] == 1 & idx_object;
            idx_ttobject_corr = [participant_event.accuracy] == 1 & idx_object;
            idx_ttobject_inc = [participant_event.accuracy] == 0 & idx_object;

            idx_ttbackground_highpas = [participant_event.pas] >= 2 & idx_background;
            idx_ttbackground_lowpas = [participant_event.pas] == 1 & idx_background;
            idx_ttbackground_corr = [participant_event.accuracy] == 1 & idx_background;
            idx_ttbackground_inc  = [participant_event.accuracy] == 0 & idx_background;
