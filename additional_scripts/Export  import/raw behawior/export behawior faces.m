behawior = 'C:\Users\user\Desktop\Behawior\Faces\';
root1 = 'D:\Drive\4 - Faces\';
...
opts.VariableTypes = ["double", "double", "double", "string", "categorical", "double", "double", "double", "double", "double", "double", "double", "string", "double", "double", "double", "double", "double", "double", "double", "categorical", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "double", "categorical", "categorical", "double", "double", "double", "double", "double", "double", "string"];
...
opts = setvaropts(opts, ["stimFile", "maskFile", "image_name", "name", "image", "mask", "VarName41"], "EmptyFieldRule", "auto");
