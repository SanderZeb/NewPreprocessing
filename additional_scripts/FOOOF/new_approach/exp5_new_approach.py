...
for participant in range(events.shape[1]):
    if participant not in participants_to_drop:
        ...
        mat_file = mat73.loadmat(rf"D:\Drive\5 - Scenes\pwelch_adjusted_timewindow\pwelch_participant_{participant+1}.mat")
        ...
        correct_trials = np.where(
            (events[0, participant]['accuracy'] == 1) & 
...
scipy.io.savemat(r'D:\results_exp5_objects.mat',
...
incorrect = np.array(incorrect, dtype=object)
# save results back to .m file
scipy.io.savemat(r'D:\results_exp5_backgrounds.mat',
                 {'results_correct': correct,
                  'results_incorrect': incorrect})