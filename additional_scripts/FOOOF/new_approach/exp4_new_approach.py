...
events = scipy.io.loadmat(r'D:\Drive\4 - Faces\events_new2.mat')
...
for participant in range(events.shape[1]):
    if participant not in participants_to_drop:
        ...
        mat_file = mat73.loadmat(rf"D:\Drive\4 - Faces\pwelch_adjusted_timewindow\pwelch_participant_{participant+1}.mat")
...
scipy.io.savemat(r'D:\results_exp4.mat', 
