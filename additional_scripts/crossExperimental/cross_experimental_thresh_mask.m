...
beta1_dir = 'D:\Drive\1 - Threshold\tfdata\betas_interaction';
beta2_dir = 'D:\Drive\3 - Mask\tfdata\betas_interaction';
...
ylabel('Exp2 B coeff Mean');
title('B coeff Accuracy Exp1 vs Exp2');
grid on;
...
xlabel('Exp1 B coeff Mean');
ylabel('Exp2 B coeff Mean');
title('B coeff PAS Exp1 vs Exp2');
grid on;
