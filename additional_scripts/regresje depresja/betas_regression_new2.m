...
mkdir(pathTFData, 'betas_interaction_regress3');
pathBETAS = [pathTFData '\betas_interaction_regress3\'];
%eeglab nogui
...
%         if any([events_new{listTFData(s).participant}.ID] == [participants_to_drop])  
%             idx(s) = 1;
%         else
%             idx(s) = 0;
%         end
