...
%     mkdir(pathTFData, 'betas_interaction_regress8');
%     pathBETAS = [pathTFData '\betas_interaction_regress8\']
 



  %mkdir(pathTFData, '\\betas_interaction_mvregress_new2');
  %pathBETAS = [pathTFData '\\betas_interaction_mvregress_new2\'] %% exp4

  mkdir(pathTFData, '\betas_interaction_mvregress_new2');
  pathBETAS = [pathTFData '\betas_interaction_mvregress_new2\']
