...
for participant in range(53,63):
    ...
    # Save results
    savemat(fr'D:\\Drive\\3 - Mask\\tfdata\fooof\fooof_participant_{participant}_aperiodic.mat', {'data': aperiodic_results})
    savemat(fr'D:\\Drive\\3 - Mask\\tfdata\fooof\fooof_participant_{participant}_periodic.mat', {'data': periodic_results})
