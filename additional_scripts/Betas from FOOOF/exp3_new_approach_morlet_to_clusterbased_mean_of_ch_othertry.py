...
for participant in range(1,168):
    ...
    for channel in selected_channels:
        filename = f'D:\\Drive\\3 - Mask\\tfdata\\tfdata_chan_{channel}_participant_{participant}.mat'
    ...
    # Save results
    savemat(fr'D:\\Drive\\3 - Mask\\tfdata\fooof2\fooof_participant_{participant}_aperiodic.mat', {'data': aperiodic_results})
    savemat(fr'D:\\Drive\\3 - Mask\\tfdata\fooof2\fooof_participant_{participant}_periodic.mat', {'data': periodic_results})
