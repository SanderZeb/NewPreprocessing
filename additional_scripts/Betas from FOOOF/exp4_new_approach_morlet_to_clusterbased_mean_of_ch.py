...
for participant in range(1,102):
    ...
    # Save results
    savemat(fr'D:\Drive\4 - Faces\tfdata\fooof\fooof_participant_{participant}_aperiodic.mat', {'data': aperiodic_results})
    savemat(fr'D:\Drive\4 - Faces\tfdata\fooof\fooof_participant_{participant}_periodic.mat', {'data': periodic_results})
