...
for participant in range(1,129):
    ...
    # Save results
    savemat(fr'D:\Drive\1 - Threshold\tfdata\fooof2\fooof_participant_{participant}_aperiodic.mat', {'data': aperiodic_results})
    savemat(fr'D:\Drive\1 - Threshold\tfdata\fooof2\fooof_participant_{participant}_periodic.mat', {'data': periodic_results})
